...
+function ($) {
  ...
  Toggle.prototype.toggle = function (options) {
  ...
  Toggle.prototype.on = function (options) {
  ...
  Toggle.prototype.off = function (options) {
    if (this.$element.prop('disabled'))
      return false
  ...
  Toggle.prototype.update = function (options) {
    if (this.$element.prop('disabled'))
      this.disable()
    else
      this.enable()
  ...
  function Plugin(option,methodOptions) {
